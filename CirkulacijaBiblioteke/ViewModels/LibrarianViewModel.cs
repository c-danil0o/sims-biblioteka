...
public class LibrarianViewModel : ViewModelBase
{
    ...
    public LibrarianViewModel(MemberService memberService, UserAccountService userAccountService,
        MembershipService membershipService, MembershipCardService membershipCardService, TitleService titleService,
        BookBorrowService bookBorrowService, PaymentService paymentService)
    {
        ...
        _currentView = new NewMemberCardViewModel(_memberService, _membershipService, _membershipCardService,
            _titleService, _bookBorrowService);
    ...
    {
        CurrentView =
            new ReturnBookViewModel(_bookBorrowService, _titleService, _paymentService, _membershipCardService);
    }
}